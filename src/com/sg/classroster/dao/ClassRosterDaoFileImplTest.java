...
class ClassRosterDaoFileImplTest {
	...
	void testAddGetStudent() throws Exception{
		...
		assertEquals(student.getLastName(), retrievedStudent.getLastName(), "Checking last name.");
		assertEquals(student.getCohort(), retrievedStudent.getCohort(), "Checking cohort.");
	}
	
	@Test
	void testAddGetAllStudent() throws Exception{
		...
		assertEquals(2, allStudents.size(), "List of students should have 2 student");
		
		// Then the specifics
		assertTrue(testDao.getAllStudents().contains(firstStudent), "The list of students should contain Ada");
		assertTrue(testDao.getAllStudents().contains(secondStudent), "The list of students should contain Charles");
	}
	...
	void testRemoveStudent() throws Exception{
		...
		// Check that the correct student object was removed
		...
		// retrieve all of the student again , and check the list.
